...
consumer_key = 'zFRZbvpracedjWAKiZGZ'
consumer_secret = 'OmPgtVLrudVsXxuMxPTLpxTJuWeMvqnQ'
...
for track in tracks:
    search_results = discogsclient.search(track['name'], type='release', artist=track['artist'])
...
# Local shipping user's local resellers
# New and 2nd vinyls
# Independent and larger retailers. xl Amazon
# Mr Vinyl
# Western Records
